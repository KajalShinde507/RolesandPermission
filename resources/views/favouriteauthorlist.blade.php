...
@section('content')
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">  Favourited Authors List Dashboard</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
...
$(document).ready(function () {
            ...
            dataSource = new kendo.data.DataSource({
                ...
                transport: {
                    read:  {
                        url: "http://localhost:8000/readfavauthor",
                        dataType: "json"
                    },
        ...
        $("#grid").kendoGrid({
            ...
            columns: [
             ...
             { field: "authorname", title: " Favourite By  Login User Authors List", width: "400px" }
