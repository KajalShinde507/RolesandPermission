...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
    ...
    <p class="e-margin"></p>
    <p  class="e-margin">Based on this request, a user account was created with a username of {{$user['email']}}  and default password   {{$pass}} </p>
    <p class="e-margin">
                ...
                <td style='background:#ED1A3B;padding:9.0pt 9.0pt 9.0pt 9.0pt'>
                    <p class=MsoNormal>
                        <span style='font-size:10.0pt;font-family:"Trebuchet MS",sans-serif;color:black'>
                            <a href="{{url('/user/verifyAdminmail', $user->verifyUser->token )}}" target="_blank" style="text-decoration:none">
                                <b>
